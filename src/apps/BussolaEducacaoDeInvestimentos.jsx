  ...
  return (
    ...
    >
      ...
      {showReservaMensalModal && (
        ...
        >
          <div className="w-full max-w-sm rounded-sm p-5 md:p-6" style={{ background: "var(--panel)", border: "1px solid var(--gold)" }}>
        ...
        <div className="px-5 md:px-10 pt-8 pb-6">
          ...
          <div className="grid grid-cols-2 gap-4 max-w-md">
            <button
              ...
              className="flex flex-col items-center gap-3 p-6 rounded-sm transition-colors"
              style={{ background: "var(--panel)", border: "1px solid rgba(237,230,214,0.15)" }}
            >
              <div className="w-16 h-16 rounded-xl flex items-center justify-center" style={{ background: "rgba(190,154,92,0.14)", border: "1px solid var(--gold)" }}>
                <Wallet size={28} color="var(--gold)" />
              </div>
      ...
      <div className="px-5 py-6 md:px-10 max-w-3xl">
        ...
        {vidaSection === null && (
          <div className="grid grid-cols-4 gap-3 max-w-2xl">
            {[
              ...
              { key: "rumo", label: "Falar com o Rumo", icon: Headphones },
              ...
              return (
                <button key={item.key} onClick={() => setVidaSection(item.key)} className="flex flex-col items-center gap-2 text-center">
                  <div className="w-14 h-14 rounded-xl flex items-center justify-center" style={{ background: "var(--panel)", border: "1px solid rgba(237,230,214,0.15)" }}>
                    <Icon size={22} color="var(--paper-dim)" />
                  </div>
        ...
        {vidaSection === "despesas" && (
        <div className="rounded-sm p-4 md:p-5 mb-5" style={{ background: "var(--panel)", border: "1px solid rgba(237,230,214,0.15)" }}>
          <div className="text-xs font-semibold uppercase tracking-wide mb-3" style={{ color: "var(--gold)" }}>Registrar despesa variável ou extra</div>
          ...
          <p className="text-[10px] mb-2" style={{ color: "var(--paper-dim)" }}>
            Exemplo pra falar: "mercado 50 reais". Depois de falar, confira os campos abaixo e clique no <strong style={{ color: "var(--gold)" }}>+</strong> pra confirmar a inclusão.
          </p>
          ...
          {voicePreview && (
            <p className="mb-3 text-xs leading-relaxed" style={{ color: "var(--paper)" }}>
              Entendi{voicePreview.valor ? "" : " parcialmente"}: já preenchi o nome, o valor{voicePreview.valor ? "" : " (não identifiquei, confira)"} e marquei "{voicePreview.tipo === "extra" ? "Extra" : "Variável"}" no formulário acima. Confira e clique no <strong style={{ color: "var(--gold)" }}>+</strong> pra confirmar a inclusão.
            </p>
          )}
